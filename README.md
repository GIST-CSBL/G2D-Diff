...
Check the comments in the notebook for further information about the source code (ex. saving checkpoints. You may need to create the directory for saving.).
